  ...
  return (
    <div className="flex py-5 md:gap-5 border-b">
      ...
      <div className="w-full flex flex-col">
        ...
        {/* PRODUCT SUBTITLE */}
        <div className="text-sm md:text-md font-medium text-black/[0.5] -ml-52">
          Men & Sport Golf Shoes
        </div>
        <div className="flex items-center justify-between mt-4">
          ...
          <RiDeleteBinLine className="cursor-pointer text-black/[0.5] hover:text-black text-[16px] md:text-[20px]" />
        </div>
      </div>
    </div>
  );
